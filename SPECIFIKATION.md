...
- Når der kastes, vises en 500 ms lang visuel rulle-animation på de terninger, der ikke er holdt. Holdte terninger står helt stille og bevarer deres viste værdi. De endelige værdier vises efter animationen. Terninger og kastknap er deaktiveret, mens animationen kører.
...
- Hver spillerkolonne viser øvre subtotal, bonus, øvre total, nedre subtotal og samlet score. Den samlede score er øvre total plus nedre subtotal.
...
Computerens basisstrategi er bevidst enkel og menneskelignende: Den vurderer kun de synlige terninger, antal kast tilbage og sine ledige kategorier. Før et nyt kast prioriterer den at holde eksisterende grupper af ens terninger, forskellige terninger som bygger mod en straight og høje terninger, der kan bruges i den øvre sektion. Den kan afslutte tidligt ved særligt stærke, færdige kombinationer som Yatzy, straight, fuldt hus eller fire ens. Når flere lovlige valg er lige gode efter denne vurdering, bruges de fælles læringsmønstre kun som afgørelse mellem dem.
